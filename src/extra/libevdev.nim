...
# Generated @ 2020-08-01T04:25:07+02:00
# Command line:
#   /home/konrad/.nimble/pkgs/nimterop-#head/nimterop/toast -p -r -n -l=libevdev.so.2 -o=libevdev.nim /usr/include/libevdev-1.0/libevdev/libevdev.h
...
{.pragma: implibevdevHdr, header: "/usr/include/libevdev-1.0/libevdev/libevdev.h".}
{.pragma: implibevdevDyn, dynlib: "libevdev.so.2".}
...
const
  ...
  LIBEVDEV_LED_OFF* = (4).libevdev_led_value ## ```
                                          ...
                                          ## ```
type
  libevdev* {.incompleteStruct, implibevdevHdr, importc: "struct libevdev".} = object
  libevdev_log_func_t* {.importc, implibevdevHdr.} = proc (
      priority: libevdev_log_priority; data: pointer; file: cstring; line: cint;
      `func`: cstring; format: cstring; args: va_list) {.cdecl.}
  libevdev_device_log_func_t* {.importc, implibevdevHdr.} = proc (dev: ptr libevdev;
      priority: libevdev_log_priority; data: pointer; file: cstring; line: cint;
      `func`: cstring; format: cstring; args: va_list) {.cdecl.}
proc libevdev_new*(): ptr libevdev {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup init
  ##   
...
proc libevdev_new_from_fd*(fd: cint; dev: ptr ptr libevdev): cint {.importc, cdecl,
  ...
  ##    @see libevdev_free
  ## ```
proc libevdev_free*(dev: ptr libevdev) {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup init
  ##   
...
proc libevdev_grab*(dev: ptr libevdev; grab: libevdev_grab_mode): cint {.importc, cdecl,
  ...
  ## ```
proc libevdev_set_fd*(dev: ptr libevdev; fd: cint): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup init
  ##   
...
proc libevdev_change_fd*(dev: ptr libevdev; fd: cint): cint {.importc, cdecl,
  ...
  ##    @see libevdev_set_fd
  ## ```
proc libevdev_get_fd*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup init
  ##   
  ##    @param dev The evdev device
...
proc libevdev_has_event_pending*(dev: ptr libevdev): cint {.importc, cdecl,
  ...
  ##    @note This function is signal-safe.
  ## ```
proc libevdev_get_name*(dev: ptr libevdev): cstring {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
...
proc libevdev_set_name*(dev: ptr libevdev; name: cstring) {.importc, cdecl,
  ...
  ## ```
proc libevdev_get_phys*(dev: ptr libevdev): cstring {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
...
proc libevdev_set_phys*(dev: ptr libevdev; phys: cstring) {.importc, cdecl,
  ...
  ##    libevdev_set_fd() will overwrite any previously set value.
  ## ```
proc libevdev_get_uniq*(dev: ptr libevdev): cstring {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
...
proc libevdev_set_uniq*(dev: ptr libevdev; uniq: cstring) {.importc, cdecl,
  ...
  ##    libevdev_set_fd() will overwrite any previously set value.
  ## ```
proc libevdev_get_id_product*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
  ##    @param dev The evdev device, already initialized with libevdev_set_fd()
...
proc libevdev_set_id_product*(dev: ptr libevdev; product_id: cint) {.importc, cdecl,
  ...
  ##    bits.
  ## ```
proc libevdev_get_id_vendor*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
  ##    @param dev The evdev device, already initialized with libevdev_set_fd()
...
proc libevdev_set_id_vendor*(dev: ptr libevdev; vendor_id: cint) {.importc, cdecl,
  ...
  ##    bits.
  ## ```
proc libevdev_get_id_bustype*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
  ##    @param dev The evdev device, already initialized with libevdev_set_fd()
...
proc libevdev_set_id_bustype*(dev: ptr libevdev; bustype: cint) {.importc, cdecl,
  ...
  ##    bits.
  ## ```
proc libevdev_get_id_version*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup bits
  ##   
  ##    @param dev The evdev device, already initialized with libevdev_set_fd()
...
proc libevdev_set_event_value*(dev: ptr libevdev; `type`: cuint; code: cuint;
                              value: cint): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup kernel
  ##   
...
proc libevdev_fetch_slot_value*(dev: ptr libevdev; slot: cuint; code: cuint;
                               value: ptr cint): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup mt
  ##   
  ...
  ##    @note This function is signal-safe.
  ## ```
proc libevdev_get_num_slots*(dev: ptr libevdev): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup mt
  ##   
...
proc libevdev_enable_event_code*(dev: ptr libevdev; `type`: cuint; code: cuint;
                                data: pointer): cint {.importc, cdecl, implibevdevDyn.}
  ## ```
  ##   @ingroup kernel
  ##   
